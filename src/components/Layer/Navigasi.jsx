  ...
  return (
    <div className="">
      <div className="flex bg-white py-3 px-2 rounded-sm cursor-pointer" onClick={toggleMenu}>
        <p className="text-xs sm:text-sm">Navigasi Udara</p>
      ...
      {isOpen && (
        <div className="py-2 px-6 text-xs bg-[#FFFFFF] rounded-md">
          <ul>
            <li></li>
            <Checkbox label="Oprasi Navigasi" type="checkbox" reference={checkboxRef} />

            <li>
              <Checkbox label="Airspace" type="checkbox" reference={checkboxRef} />
            </li>
          </ul>
        </div>
      )}
