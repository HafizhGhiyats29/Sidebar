  ...
  return (
    <div className="">
      <div className="flex bg-white py-3 px-2 rounded-sm cursor-pointer" onClick={toggleMenu}>
        <p className="text-xs sm:text-sm">Laporan Intelegent</p>
      ...
      {isOpen && (
        <div className="py-2 px-6 text-xs bg-[#FFFFFF] rounded-md">
          <ul>
            <li>
              <Checkbox label="BHI" type="checkbox" reference={checkboxRef} />
            </li>
            <li>
              <Checkbox label="Laporan Oprasi Intelegen" type="checkbox" reference={checkboxRef} />
            </li>
          </ul>
        </div>
      )}
